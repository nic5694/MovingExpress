              ...
              <div className="flex flex-row gap-1 py-3">
                {
                  ...
                  ((selectedQuote.quoteStatus !== "DECLINED") && (selectedQuote.quoteStatus !== "CREATED")) ?
                    <div className="flex flex-row gap-1 justify-end mb-5">
                      <div>
                        <button id='createBtn' style={{ fontFamily: 'Bebas Neue, cursive'}} onClick={() => { updateQuoteStatus(selectedQuote.quoteId); createShipment();}} className='px-2.5 py-1 text-sm bg-companyYellow text-white rounded-sm'>
                          Request Shipment
                        </button>
                      </div>
