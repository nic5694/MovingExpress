                ...
                <div>
                    <form>
                        <div className="flex flex-col gap-2 mb-10">
                            ...
                            >
                                Personal{' '}
                                <span className="text-companyYellow">
                                    information
                                </span>
                            </div>
                            ...
                            <div className="bg-white shadow-lg border rounded-md flex flex-col gap-5 px-10 py-10">
                                ...
                                <div>
                                    <textarea
                                        ...
                                        placeholder="Additional comments / instrcutions (Specific hours, crane required...)"
                            ...
                            <div className="bg-white shadow-lg border rounded-md flex flex-col gap-5 px-10 py-10">
                                ...
                                <div className="flex gap-5 flex-wrap">
                                    <div className="flex flex-col gap-1">
                                        <input
                                            type="text"
                                            className="border border-[lightgray] text-sm  h-[35px] px-4 rounded-sm py-1 w-[300px]"
                                            id="CityInputP"
                                            name="CityInputP"
                                            placeholder="City"
                                            required
                            ...
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <button
                                        ...
                                        className="text-white text-[13px] bg-companyYellow px-10 py-2 rounded-md shadow-md"
                                        style={{
                                            fontFamily: 'Bebas Neue, cursive',
                                        }}
