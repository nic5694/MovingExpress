...
async function signin_signout_testcase() {
    ...
    const signUpLink = await driver.wait(
        until.elementLocated(By.xpath('/html/body/div/main/section/div/div[2]/div/div[1]/p/a')),
        10000
    );
    ...
    const pwdSignUpInput = await driver.wait(
        until.elementLocated(By.xpath('/html/body/div/main/section/div/div/div/form/div[1]/div[1]/div/div[2]/div/input')), 1000);
    await pwdSignUpInput.sendKeys(password);

    const continueBtn = await driver.wait(
        until.elementLocated(By.xpath('/html/body/div/main/section/div/div/div/form/div[3]/button')), 1000);
    continueBtn.click()

    await new Promise(resolve => setTimeout(resolve, 2000));
    const AcceptBtn = await driver.findElement(By.xpath('/html/body/div/main/section/div/div/div/form/div[3]/button[1]'));
    AcceptBtn.click()

    await new Promise(resolve => setTimeout(resolve, 2000));
    const loginBtnLogin = await driver.findElement(By.id('signinsignuplandingpage'));
    loginBtnLogin.click()
    // Wait for 1 seconds
    await new Promise(resolve => setTimeout(resolve, 1000));
